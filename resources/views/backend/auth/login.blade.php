...
<head>
    ...
    <title>DATIKA Shop Backend | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="./../backend/admin/plugins/iCheck/square/blue.css">
    ...
    <div class="login-box-body">
        ...
        <form action="{{ route('backend.postLogin') }}" method="post">
            ...
            <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                <input type="text" name="username" class="form-control" placeholder="Username" value="{{ old('email') }}"
                       required autofocus>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" {{ old('remember') ? 'checked' : '' }} name="remember" value="true">
                            Remember Me
                        </label>
                    </div>
                </div>
...
<!-- iCheck -->
<script src="./../backend/admin/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
